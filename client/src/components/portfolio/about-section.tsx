        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="text-lg leading-relaxed text-muted-foreground space-y-4">
              <p>
                Hi, I'm <strong className="text-foreground">Sushil Rahatole</strong>, a passionate{" "}
                <strong className="text-primary">Full Stack Developer</strong> and lifelong tech explorer 
                currently pursuing my Bachelor's in Computer Engineering. I've always believed that{" "}
                <strong className="text-foreground">great code isn't just functional — it's thoughtful, elegant, and user-focused.</strong>
              </p>

              <p>
                My journey began with curiosity and a love for solving real-world problems. From building{" "}
                <strong className="text-accent">AI-powered interview platforms</strong> to crafting full-fledged{" "}
                <strong className="text-accent">E-commerce and rental web apps</strong>, I've explored a wide range of 
                technologies — including <strong className="text-primary">React.js, Node.js, MongoDB, Firebase</strong>, 
                and more. I'm constantly learning and pushing my boundaries with every project I take on.
              </p>

              <p>
                I'm currently working on <strong className="text-secondary">creative MERN-based clones</strong> and 
              ...
              <p>
                ...
                <strong className="text-foreground">create things that people love to use.</strong> That's why I care 
